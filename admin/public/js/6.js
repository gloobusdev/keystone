...
return!!(l&&s&&n&&Q.indexOf(n)!==-1)&&(o[c]=o[c]?o[c]:{},o[c][u]=o[c][u]?o[c][u]:{},o[c][u][n]=t,this.setState({value:i({},this.state.value,{content:o})}),void this.props.onChange({path:this.props.path,value:i({},this.state.value,{content:o})}))},updateValuesInEditorOnChangeSomething:function(){var e=this.fetchSafeEditorValue(L)
...
case L:case O:return'<div class="templateBasicStyleAuto" style="font-size: 11pt; font-family: Arial;"></div>'
...
if(!i||!a||!e||Q.indexOf(e)===-1)return l
var s=[i,a,e].join(".")
...
return c.default.createElement("div",null,c.default.createElement(y.Flex,{column:!0,alignItems:"start"},c.default.createElement(y.Flex,{row:!0},c.default.createElement("span",{className:h.default.fieldTitle},"Email body")),c.default.createElement(y.Flex,{row:!0},c.default.createElement("span",{className:h.default.fieldLabel},"Edit body of the email template."))),this.renderButtonRowForFillContent(this.insertContentToBody),c.default.createElement(v.default,{ref:"customEditor2",onChange:function(t){return e.onEditorStateChange({value:t.target.getContent(),nameOfTarget:"body"})},config:{menubar:!1,statusbar:!1,height:200,force_br_newlines:!1,force_p_newlines:!1,forced_root_block:"",relative_urls:!1,remove_script_host:!1,allow_script_urls:!0,convert_urls:!0,extended_valid_elements:"div[class|style]",plugins:"code",toolbar:"undo redo | bold italic underline strikethrough | alignleft aligncenter alignright | styleselect | formatselect fontselect fontsizeselect | code",setup:function(e){S=S?S:e,e.on("init",function(){this.execCommand("fontName",!1,"Arial"),this.execCommand("fontSize",!1,"11pt")})}},content:t}))},changeIndexType:function(e,t){var n=this.state.currentTabRecipient,r=n.value||"",o=["value","content",r,P,Y,"type"].join("."),a=["value","content",r,P,Y,"lowValue"].join("."),l={type:null===e?b.default.get(this.state,o)||"":e,lowValue:null===t?b.default.get(this.state,a)||"":t},s=["value","content",r,P,Y].join(".")
