...
return c.default.createElement("div",null,c.default.createElement(y.Flex,{column:!0,alignItems:"start"},c.default.createElement(y.Flex,{row:!0},c.default.createElement("span",{className:h.default.fieldTitle},"Email body")),c.default.createElement(y.Flex,{row:!0},c.default.createElement("span",{className:h.default.fieldLabel},"Edit body of the email template."))),this.renderButtonRowForFillContent(this.insertContentToBody),c.default.createElement(v.default,{ref:"customEditor2",onChange:function(t){return e.onEditorStateChange({value:t.target.getContent(),nameOfTarget:"body"})},config:{menubar:!1,statusbar:!1,height:200,toolbar:"undo redo | bold italic underline strikethrough | alignleft aligncenter alignright | styleselect | formatselect fontselect fontsizeselect",setup:function(e){S=S?S:e}},content:t}))},changeIndexType:function(e,t){var n=this.state.currentTabRecipient,r=n.value||"",i=["value","content",r,P,Y,"type"].join("."),a=["value","content",r,P,Y,"lowValue"].join("."),l={type:null===e?b.default.get(this.state,i)||"":e,lowValue:null===t?b.default.get(this.state,a)||"":t},s=["value","content",r,P,Y].join(".")
